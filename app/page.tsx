                ...
                >
                    ...
                    <div className="flex h-auto min-h-[1123px] w-[794px] shrink-0 flex-col rounded-lg bg-white p-6 text-[11px] text-black">
                        ...
                        <section className="flex flex-col gap-6 py-6">
                            <div className="flex items-center justify-between border-b border-black pb-2">
                                <div className="flex items-center gap-2">
                                    <Badge variant="secondary" className="w-5! rounded-xs font-semibold bg-blue-100 text-blue-900 border border-blue-200">
                                        4
                                    </Badge>
                                ...
                                <div className="mt-2 flex w-full flex-col items-center gap-3 rounded-sm border border-neutral-500 p-3">
                                    ...
                                    <div className="flex w-full flex-col gap-2.5 text-left">
                                        {[
                                            ...
                                            <div key={member.name} className={`flex w-full border ${member.isCEO ? 'border-blue-300' : 'border-neutral-400'} bg-white text-left`}>
                                                <div className={`flex w-36 shrink-0 flex-col items-start justify-center border-r ${member.isCEO ? 'border-blue-300 bg-blue-50/70' : 'border-neutral-400 bg-neutral-100'} p-2.5`}>
                                                    <span className={`border ${member.isCEO ? 'border-blue-800 bg-blue-900' : 'border-neutral-700 bg-neutral-800'} px-1.5 py-0.5 text-[9px] font-bold text-white`}>
                                                        {member.role}
                                                    </span>
                                                    <span className={`mt-1 text-sm font-bold ${member.isCEO ? 'text-blue-950' : 'text-neutral-900'}`}>{member.name}</span>
                                ...
                                <div className="mt-2 flex w-full flex-col items-center gap-3 border border-neutral-500 bg-white p-3">
                                    ...
                                    <div className="flex w-full items-stretch gap-2">
                                        {[
                                            ...
                                            <div key={item.year} className={`flex flex-1 flex-col gap-2 border ${item.isKey ? 'border-blue-300 bg-blue-50/20' : 'border-neutral-300 bg-white'} p-2.5 text-left`}>
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-1.5">
                                                        <span className={`flex h-5 w-5 items-center justify-center border ${item.isKey ? 'border-blue-700 bg-blue-900 text-white' : 'border-neutral-400 bg-neutral-100 text-neutral-800'} text-[9px] font-bold`}>
                                                            {i + 1}
                                                        </span>
                                                    ...
                                                    <span className={`border ${item.isKey ? 'border-blue-300 bg-blue-50 text-blue-900' : 'border-neutral-200 bg-neutral-50 text-neutral-800'} px-2 py-0.5 text-[10px] font-bold`}>
                                                        {item.hires}
                                                    </span>
                                                </div>
                                                ...
                                                <div className={`mt-auto border-t border-neutral-200 pt-1.5 text-[10px] font-semibold ${item.isKey ? 'text-blue-900' : 'text-neutral-600'}`}>
                                                    - {item.goal}
                                                </div>
                                            </div>
                                        ))}
                                    ...
                                    <div className="flex w-full flex-col gap-2 border border-neutral-300 bg-neutral-50 p-3 text-left">
                                        ...
                                        {[
                                            ...
                                            <div key={row.dept} className="flex items-center gap-2 text-[10px]">
                                                <span className={`w-24 shrink-0 font-medium ${row.isTech ? 'font-bold text-blue-950' : 'text-neutral-700'}`}>{row.dept}</span>
                                                ...
                                                <div className="flex w-28 shrink-0 items-center justify-end gap-1 text-neutral-500">
                                                    <span>
                                                        {row.y1} → {row.y2} → <strong className={`font-bold ${row.isTech ? 'text-blue-900' : 'text-neutral-900'}`}>{row.y3}</strong> 명
                                                    </span>
                                                </div>
                                            </div>
                                        ))}
                                ...
                                <div className="mt-2 flex w-full flex-col items-center gap-3 border border-neutral-500 bg-white p-3">
                                    ...
                                    <div className="flex w-full flex-col gap-0.5 border border-neutral-300 bg-white p-3 text-left">
                                        ...
                                        {[
                                            ...
                                            { category: '연구개발비', amount: 130000000, ratio: 20.0, desc: 'AI 모델 개발·데이터 수집·검증 비용', isCore: true },
                                            ...
                                            <div key={item.category} className="flex flex-col gap-1">
                                                <div className="flex items-center justify-between text-[10px]">
                                                    <div className="flex items-center gap-1.5">
                                                        <span className={`w-16 font-bold ${item.isCore ? 'text-blue-900' : 'text-neutral-900'}`}>{item.category}</span>
                                                        <span className="text-neutral-500">| {item.desc}</span>
                                                    </div>
                                                    <div className="flex shrink-0 items-center gap-3">
                                                        <span className={`font-bold ${item.isCore ? 'text-blue-900' : 'text-neutral-800'}`}>{(item.amount / 100000000).toFixed(2)}억 원</span>
                                                ...
                                                <div className="h-1.5 w-full overflow-hidden bg-neutral-100">
                                                    <div className={`h-full ${item.isCore ? 'bg-blue-800' : 'bg-neutral-600'}`} style={{ width: `${item.ratio}%` }} />
                                                </div>
                                    ...
                                    <div className="flex w-full flex-col border border-blue-900 text-[10px]">
                                        ...
                                        {[
                                            ...
                                            >
                                                <div className={`flex items-center justify-center border-r border-neutral-300 ${row.isCore ? 'bg-blue-50/70 font-bold text-blue-900' : 'bg-neutral-50 font-semibold text-neutral-800'} py-1.5`}>
                                                    {row.category}
                                                </div>
                                        ...
                                        <div className="grid w-full grid-cols-5 border-t border-blue-900 bg-blue-900 font-bold text-white">
                                            ...
                                            <div className="flex items-center justify-center py-2 text-white font-extrabold">65,000만원</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
